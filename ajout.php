...
/*Récupération des données du formulaire (methode "get") 
pas de isset car l'opérateur ?? remplace  la vérification avec isset()*/
$id= $_GET ["id"]?? 0;
$nom = $_GET["nom"] ?? 0;
$genre = $_GET["genre"] ?? 0;
...
// Lier les valeurs aux paramètres de la requête Info reçue d'Anthony
...
// Exécuter la requête info d' apres AI
try {
    $query->execute();
    echo "Insertion réussie";

    // Récupérer l'ID de la dernière insertion pris info sur google
